...
## Final gate
Performance/regression status is accepted only when the final same-commit JVM/business/performance task and all connected suites pass. Any failure keeps the phase at `PHASE 3 PART 3B NOT COMPLETE`.
