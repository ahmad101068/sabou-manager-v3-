...
EXPECTED_LINT_HOTFIX_GIT_BLOB="53a65158bb99f99371fc4bd5f3f6f5816219e8ae"
...
test -f _ci/alpha1621-lint-rootfix.patch || { echo "Missing API23-safe lint root-fix"; exit 1; }
...
ACTUAL_LINT_HOTFIX_GIT_BLOB="$(git hash-object _ci/alpha1621-lint-rootfix.patch)"
...
patch --forward --batch -p1 < "$GITHUB_WORKSPACE/_ci/alpha1621-lint-rootfix.patch"
