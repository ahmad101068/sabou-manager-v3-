...
ACTUAL_ANDROIDTEST_HOTFIX_GIT_BLOB="$(git hash-object _ci/alpha1621-androidtest-compile-hotfix.patch)"
test "$ACTUAL_ANDROIDTEST_HOTFIX_GIT_BLOB" = "$EXPECTED_ANDROIDTEST_HOTFIX_GIT_BLOB" || {
